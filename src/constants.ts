...
export const regex = [
    ...
    {
        "name": "Common RCE",
        "regex": "/(?:exec|execute|cmd|command|shell)/gm",
    ...
    },
    {
        ...
        "regex": "/(?:ClassLoader|Class\.forName|Reflection)/gm",
    ...
    },
    {
        ...
        "regex": "/(?:javax\.management\.loading\.MLet|.*\:eval|.*\:bash|.*\:python)/gm",
    ...
    },
    {
        ...
        "regex": "/(?:System\.getProperties|System\.getProperty)/gm",
